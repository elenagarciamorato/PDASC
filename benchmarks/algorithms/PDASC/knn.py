...
def PDASC(config_file):
    ...
    index = pdasc_flues_.create_index_flues(vector_training, dataset, group_size, n_centroids, n_nodes, distance, algorithm, implementation)
    ...
    file_name = "./benchmarks/NearestNeighbors/" + dataset + "/knn_" + dataset + "_" + str(
        k) + "_" + distance + "_" + method + "_tg" + str(group_size) + "_nc" + str(n_centroids) + "_r" + str(
        radius) + "_n" + str(n_nodes) + ".hdf5"
