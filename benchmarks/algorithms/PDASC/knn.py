...
def PDASC(config_file):
    ...
    logging.info("")
    logging.info('---- PDASC Parameters - tam_grupo=%s - n_centroids=%s - radius=%s - algorithm=%s - implementation=%s ----', tam_grupo, n_centroides, radius, algorithm, implementation)
    logging.info('------------------------------------------------------------------------\n')
    ...
    file_name = "./benchmarks/NearestNeighbors/" + dataset + "/knn_" + dataset + "_" + str(k) + "_" + distance + "_" + method + "_tg" + str(tam_grupo) + "_nc" + str(n_centroides) + "_r" + str(radius) + "_" + str(algorithm) + "_" + str(implementation) + ".hdf5"
